...
int k=0; //количество несдавших
bool flage=false; //флаг
System.Console.WriteLine("Введите оценки через Enter:");
for(int i=0;i<n;i++)
{
...
System.Console.WriteLine($"Количество несдавших: {k}");
if (flage) System.Console.WriteLine("Yes");
